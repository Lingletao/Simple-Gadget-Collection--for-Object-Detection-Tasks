...
First, you need to use mmdetection and a small amount of *labeled data* (about 200~300 images) to train to get a rough target detection model. Then use this annotation tool to mark the remaining large amount of unmarked data and generate a VOC format (xml) file. Finally, you can choose to use LabelImg to manually correct the automatically generated files, avoiding a lot of manpower to label data. 
